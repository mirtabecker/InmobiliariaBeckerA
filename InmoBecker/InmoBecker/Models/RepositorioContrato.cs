		...
		public int Alta(Contrato c)
        {
			...
			using (SqlConnection connection = new SqlConnection(connectionString))
            {
				string sql = $"INSERT INTO Contratos (Monto, FechaInicio, FechaCierre, InquilinoId, InmuebleId)" +
							 "VALUES (@monto, @fechaInicio, @fechaCierre, @inquilinoId, @inmuebleId);" +
		...
		public int Modificacion(Contrato c)
		{
			...
			using (SqlConnection connection = new SqlConnection(connectionString))
			{
				string sql = "UPDATE Contratos SET " +
					 "Monto=@monto, FechaInicio = @fechaInicio, FechaCierre = @fechaCierre, InquilinoId = @inquilinoId, InmuebleId = @inmuebleId "+
					"WHERE IdContrato = @id";
				using (SqlCommand command = new SqlCommand(sql, connection))
				{
